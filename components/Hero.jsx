          ...
          <div className="flex justify-center items-center">
            <div className="relative">
              <Image
                ...
                height={1000}
                priority={true}
                sizes="(max-width: 640px) 320px, (max-width: 768px) 500px, (max-width: 1024px) 600px, (max-width: 1280px) 700px, 768px"
                className="w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl h-auto object-contain opacity-90"
              />
              {/* Glow effect usando CSS puro - más eficiente */}
              <div className="absolute inset-0 bg-primary/20 rounded-lg blur-xl -z-10 scale-110" />
            </div>
          </div>
        </div>
      </div>
